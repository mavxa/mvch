...
describe('mock state', () => {
  test('emergency stop blocks motion and tool state is retained', () => {
    ...
    applyMockCommand(state, { type: 'lift', robot: 'RMC2', height: 0.05 })
